...
if [ ! -e $zsh_plugins_path/zsh-z ]; then
	git clone --depth 1 https://github.com/agkozak/zsh-z.git $zsh_plugins_path/zsh-z
...
if [ ! -e $zsh_plugins_path/zsh-fzf-history-search ]; then
	git clone --depth 1 https://github.com/joshskidmore/zsh-fzf-history-search.git $zsh_plugins_path/zsh-fzf-history-search
